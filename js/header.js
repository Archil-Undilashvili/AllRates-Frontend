...
<div style="width: calc(100% + 40px); background-color: var(--card-bg); box-shadow: var(--shadow-sm); display: flex; justify-content: center; margin-bottom: 40px; margin-top: 0; padding: 15px 20px; margin-left: -20px; margin-right: -20px; border-bottom: 1px solid var(--border); box-sizing: border-box; z-index: 10;">
    <nav style="width: 100%; max-width: 1400px; display: flex; justify-content: space-between; align-items: center; box-sizing: border-box;">
        ...
        <div style="display: flex; align-items: center; margin-left: auto; gap: 24px;">
            ...
            <a href="official.html" class="nav-link" data-page="official" style="text-decoration: none; color: #64748b; font-weight: 700; font-size: 14px; cursor: pointer; text-transform: uppercase; transition: color 0.2s ease;">ოფიციალური კურსები</a>
            <a href="api.html" class="nav-link" data-page="api" style="text-decoration: none; color: #64748b; font-weight: 700; font-size: 14px; cursor: pointer; text-transform: uppercase; transition: color 0.2s ease;">API სერვისი</a>
            <a href="contact.html" class="nav-link" data-page="contact" style="text-decoration: none; color: #64748b; font-weight: 700; font-size: 14px; cursor: pointer; text-transform: uppercase; transition: color 0.2s ease;">კონტაქტი</a>
        </div>
    </nav>
</div>
`);
