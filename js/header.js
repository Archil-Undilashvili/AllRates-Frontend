...
<div class="site-header">
    <nav class="site-nav">
        ...
        <div class="site-nav-links" id="site-nav-links">
            ...
            <a href="/rates" class="nav-link" data-page="rates">შეადარე კურსები</a>
            <a href="/calculator" class="nav-link calculator-nav-link" data-page="calculator">კონვერტაციის კალკულატორი <span>(მოძებნე საუკეთესო კურსი)</span></a>
            <a href="/official" class="nav-link" data-page="official">ოფიციალური კურსები</a>
