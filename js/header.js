...
<div style="width: calc(100% + 40px); background-color: var(--card-bg); box-shadow: var(--shadow-sm); display: flex; justify-content: center; margin-bottom: 40px; margin-top: 0; padding: 15px 20px; margin-left: -20px; margin-right: -20px; border-bottom: 1px solid var(--border); box-sizing: border-box; z-index: 10;">
    <nav style="width: 100%; max-width: 1400px; display: flex; justify-content: space-between; align-items: center; box-sizing: border-box;">
        ...
        <div style="display: flex; align-items: center; margin-left: auto; gap: 24px;">
            ...
            <a href="rates.html" class="nav-link" data-page="rates" style="text-decoration: none; color: var(--text-muted); font-weight: 700; font-size: 14px; cursor: pointer; text-transform: uppercase; transition: color 0.2s ease;">ვალუტის კურსები ქართულ ბაზარზე</a>
            <a href="calculator.html" class="nav-link" data-page="calculator" style="position: relative; text-decoration: none; color: var(--text-muted); font-weight: 700; font-size: 14px; cursor: pointer; text-transform: uppercase; transition: color 0.2s ease;">კონვერტაციის კალკულატორი <span style="position: absolute; top: 100%; left: 50%; transform: translateX(-50%); font-size: 12px; text-transform: none; font-weight: normal; margin-top: 4px; white-space: nowrap; text-align: center; color: var(--text-muted);">(მოძებნე საუკეთესო კურსი)</span></a>
