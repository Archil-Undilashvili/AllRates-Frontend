                    ...
                    <td class="company-name">
                        <a href="${compUrl}" target="_blank" rel="noopener noreferrer" style="text-decoration: none; display: block;">
                            <div style="display: flex; align-items: center; gap: 14px; padding: 4px 0;">
                                ${logoUrl ? `<div style="width: 44px; height: 44px; border-radius: 50%; background: #ffffff; border: 2px solid var(--border); display: flex; align-items: center; justify-content: center; flex-shrink: 0; box-sizing: border-box; overflow: hidden; padding: 5px;"><img src="${logoUrl}" alt="${compNameKa}" class="${logoClass}" style="width: 100%; height: 100%; object-fit: contain;"></div>` : `<div style="width: 44px; height: 44px; border-radius: 50%; background: rgba(255,255,255,0.08); border: 2px solid var(--border); display: flex; align-items: center; justify-content: center; flex-shrink: 0; box-sizing: border-box;"><span style="font-weight:bold; font-size: 18px; color:${initialColor};">${mainName.charAt(0)}</span></div>`}
