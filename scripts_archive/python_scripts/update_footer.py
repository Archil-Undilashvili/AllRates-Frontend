...
footer_html = """    <!-- Footer Section -->
    <footer style="margin-top: 60px; padding: 40px 20px 20px; background: var(--card-bg); border-top: 1px solid var(--border); box-shadow: 0 -4px 10px rgba(0, 0, 0, 0.02);">
        <div style="max-width: 1200px; margin: 0 auto; display: flex; flex-wrap: wrap; justify-content: space-between; gap: 30px;">
            <!-- Column 1: Menu -->
            <div style="flex: 1; min-width: 200px;">
                <h4 style="color: var(--text-main); font-size: 1.1em; margin-bottom: 15px; display: flex; align-items: center; gap: 8px;">
                ...
                <style>
                    .footer-nav-link { color: var(--text-muted); text-decoration: none; font-size: 0.95em; transition: color 0.2s; display: inline-block; padding: 2px 0; }
                    .footer-nav-link:hover { color: var(--primary); }
                    .footer-social-link { color: var(--text-muted); transition: all 0.2s; display: flex; align-items: center; justify-content: center; width: 40px; height: 40px; border-radius: 50%; background: var(--bg-main); border: 1px solid var(--border); }
        ...
        <div style="max-width: 1200px; margin: 30px auto 0; padding-top: 20px; border-top: 1px solid var(--border); text-align: center; color: var(--text-muted); font-size: 0.85em;">
...
files_to_update = [
    '/Users/archilundilashvili/Desktop/allrates.ge/calculator.html',
    '/Users/archilundilashvili/Desktop/allrates.ge/index.html',
    '/Users/archilundilashvili/Desktop/allrates.ge/official.html',
    '/Users/archilundilashvili/Desktop/allrates.ge/rates.html'
]
...
for file_path in files_to_update:
    try:
        ...
        # Regular expression to match everything from <!-- Footer Section --> to </footer>
        new_content = re.sub(r'<!-- Footer Section -->\s*<footer.*?</footer>', footer_html, content, flags=re.DOTALL)
        
        # If the comment doesn't exist, try to match just <footer ...> ... </footer>
