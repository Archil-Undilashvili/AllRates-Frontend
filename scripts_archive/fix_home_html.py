...
# We want to replace the whole block starting from `<div class="home-section" ... USD` until `საერთაშორისო კურსები`
start_marker = '<div class="card-uniform-content" style="justify-content: flex-start;">'
...
pattern = r'<div class="card-uniform-content" style="justify-content: flex-start;">(.*?)</div>\s*<!-- International Rates Card -->'
